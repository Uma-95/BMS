...
public class WithdrawalDepartmentSBI extends DepartmentSBI {

UserSBI user;//has a user who has a bank account
int amount_withdrawed;

public WithdrawalDepartmentSBI(UserSBI usr,int amount) {
