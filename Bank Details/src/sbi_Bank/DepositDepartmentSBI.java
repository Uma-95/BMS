...
public class DepositDepartmentSBI extends DepartmentSBI {
UserSBI user; //has a user and user has bank account
int amount_deposited;

//constructor
public DepositDepartmentSBI(UserSBI usr,int amount) {
