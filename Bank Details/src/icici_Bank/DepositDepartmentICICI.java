...
import sbi_Bank.UserSBI;

public class DepositDepartmentICICI extends DepartmentICICI{
	UserICICI user; //has a user and user has bank account
	int amount_deposited;

	//constructor
	public DepositDepartmentICICI(UserICICI usr,int amount) {
