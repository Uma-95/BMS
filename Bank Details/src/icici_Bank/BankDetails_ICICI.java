...
import Main.*;
//for ICICI BANK
public abstract class BankDetails_ICICI implements BankICICI {
	public void callICICI() {}
...
//	abstract  BankDetails_SBI(String name,String ifsc,String nickName);
  ...
  BankDetails_ICICI(String name,String ifsc,String nickName) {
		this.balance=0.0;
		this.name=name;
		this.ifsc=ifsc;
